...
namespace PollutionTracker.Controllers
{
    public class AreasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AreaID,AreaName,Latitude,Longitude,CreatedAt")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AreaID,AreaName,Latitude,Longitude,CreatedAt")] Area area)
        {
            if (id != area.AreaID)
            {
                return NotFound();
